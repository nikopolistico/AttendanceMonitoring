<template>
  <div
    ...
    style="background: linear-gradient(135deg, #002e5c 0%, #001a3d 50%, #003d7a 100%)"
  >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center max-w-7xl mx-auto">
        ...
        <div class="text-white space-y-6 lg:space-y-10">
          ...
          <div class="text-center lg:text-left space-y-6">
            <div>
              <p
                class="text-sm lg:text-base font-semibold uppercase tracking-wider mb-3 opacity-90"
              >
                Welcome to
              </p>
            ...
            <p
              class="text-base lg:text-xl opacity-90 leading-relaxed max-w-lg mx-auto lg:mx-0 text-justify"
            >
              Secure access to the <span class="font-bold">Police Station 1</span> attendance
              monitoring dashboard. Track, manage, and monitor personnel attendance efficiently.
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-5 lg:p-8 w-full max-w-md mx-auto">
          ...
          <div class="mb-6">
            ...
            <div class="relative">
              <select
                v-model="loginType"
                class="w-full px-4 py-3 text-sm border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 transition appearance-none cursor-pointer"
                style="border-color: #e5e7eb; color: #1f2937"
              >
          ...
          <div v-if="loginType === 'administrator'" class="space-y-5">
            ...
            <div
              v-if="errorMessage"
              class="border-l-4 p-3 rounded-lg"
              style="background: #fef2f2; border-color: #dc2626"
            >
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 text-sm border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 transition"
                style="border-color: #e5e7eb; color: #1f2937; background: #f9fafb"
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  placeholder="••••••••••••••••"
                  class="w-full px-4 py-3 pr-12 text-sm border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 transition"
                  style="border-color: #e5e7eb; color: #1f2937; background: #f9fafb"
                  @keyup.enter="handleAdminLogin"
                />
                <button
                  ...
                  class="absolute right-3 top-1/2 transform -translate-y-1/2 focus:outline-none transition hover:opacity-70"
                  style="color: #9ca3af"
                >
                  <svg
                    v-if="!showPassword"
            ...
            <div class="flex items-center justify-between">
              ...
              <a href="#" class="text-sm hover:underline" style="color: #0066cc"
                >Forgot password?</a
              >
            </div>
            ...
            <button
              ...
              :disabled="isLoading"
              class="w-full text-white font-semibold py-3.5 text-sm rounded-lg transition duration-200 disabled:opacity-50 hover:opacity-90 flex items-center justify-center gap-2 shadow-lg"
          ...
          <div v-else class="space-y-5">
            ...
            <div
              class="border-l-4 p-5 rounded-lg"
              style="background: #f0f9ff; border-color: #003d7a"
            >
              <p class="text-base font-semibold mb-2" style="color: #1f2937">
                Officer/Personnel Access
              </p>
              <p class="text-sm" style="color: #6b7280">Click proceed to record your attendance</p>
            </div>
            <button
              @click="handleUserProceed"
              class="w-full text-white font-semibold py-3.5 text-sm rounded-lg transition duration-200 hover:opacity-90 flex items-center justify-center gap-2 shadow-lg"
              style="background: #003d7a"
            >
