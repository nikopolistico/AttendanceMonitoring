    ...
    >
      <div class="flex justify-around items-center">
        ...
        >
          ...
          <span class="text-xs font-bold" style="color: #004595">Overview</span>
        </div>
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex-1">
                  ...
                  <p class="text-2xl sm:text-3xl font-bold mb-1" style="color: #10b981">
                    {{ todayCheckIns }}
                  </p>
                  <p class="text-xs font-semibold" style="color: #9ca3af">{{ currentDate }}</p>
                </div>
                <div
                  class="rounded-xl p-2 group-hover:scale-110 transition-transform duration-300"
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex-1">
                  ...
                  <p class="text-2xl sm:text-3xl font-bold mb-1" style="color: #004595">
                    {{ totalOfficers }}
                  </p>
...
const officersWithoutAttendance = computed(() => {
  return allUsers.value.filter((user) => !todayAttendanceUserIds.value.includes(user.id))
})
